    ...
    return(
        <>
            ...
            <div className='container-fluid'>
                        ...
                        <img src={card2} className='card1'/>

                        <div className='col-lg-12'>
                            <div className='row'>
                                <div className='col-lg-6'>
                                    <h2 className='sab mt-4 vig'>Vignesh Kumar</h2>
                                    <h5 className='text-warning vig3'>Full Stack Developer</h5>
                                    <h5 className='text-secondary vign3'>Banglore,Karnataka</h5>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div>
                                            <h5 className='mt-3 ml-5'>21</h5>
                                            <h5 className='mt-3 ml-5'>25.01.2002</h5>
                                            <h5 className='mt-3 ml-5'>Un-Married</h5>
                                            <h5 className='mt-3 ml-5'>2/180,Peocock nagar,Banglore</h5>
                                            <h5 className='mt-3 ml-5'>Five years</h5>                           
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='col-lg-6'>
                                    ...
                                    <ul>
                                        <li className='mt-4'>Grade: B.Sc Computer Science Grade:B.Sc Computer
                                            Science
                                        </li>
